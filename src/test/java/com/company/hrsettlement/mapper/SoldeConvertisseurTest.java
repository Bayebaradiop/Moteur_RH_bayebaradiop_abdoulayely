...
@DisplayName("Conversion entre le contrat d'API et le metier")
class SoldeConvertisseurTest {
	...
	void doitConvertirLaRequeteVersLeDomaine() {
		SoldeRequeteDto requete = new SoldeRequeteDto(
				"EMP-042",
	...
	void doitConvertirLeSoldeVersLaReponse() {
		...
		SoldeReponseDto reponse = soldeConvertisseur.versReponse(solde);
