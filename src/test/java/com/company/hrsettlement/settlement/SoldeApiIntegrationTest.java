...
import com.company.hrsettlement.settlement.infrastructure.persistence.HistoriqueSoldeDepotJpa;
...
class SoldeApiIntegrationTest {
	...
	@Autowired
	private HistoriqueSoldeDepotJpa historiqueSoldeDepotJpa;
	...
	void doitArchiverLeSoldeEnBase() throws Exception {
		...
		assertThat(historiqueSoldeDepotJpa.findByMatriculeEmploye("EMP-900"))
				.singleElement()
				.satisfies(archive -> {
