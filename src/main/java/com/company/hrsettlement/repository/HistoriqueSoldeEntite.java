 ...
 * <p>
 * Distincte du record {@code Solde} : les contraintes de JPA (constructeur sans
 * argument, champs mutables, identifiant technique) ne doivent pas rendre le
 * modele metier mutable.
 */
@Entity
...
public class HistoriqueSoldeEntite {
	...
	public HistoriqueSoldeEntite(String matriculeEmploye,
