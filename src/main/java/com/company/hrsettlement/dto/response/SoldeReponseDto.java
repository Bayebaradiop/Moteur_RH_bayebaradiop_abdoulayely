package com.company.hrsettlement.dto.response;
 ...
 * <p>
 * Distinct du modele metier : la structure interne peut evoluer sans casser les
 * clients de l'API.
 */
@Schema(description = "Detail du solde de tout compte")
public record SoldeReponseDto(
		...
		@Schema(description = "Impot du", example = "0.00")
		BigDecimal montantImpot,

		@Schema(description = "Montant net verse", example = "1812500.00")
